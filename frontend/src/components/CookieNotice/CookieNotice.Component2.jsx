          ...
          <div className="cookie-notice-container">
            <div className="cookie-notice-wrapper">
              <div className="cookie-notice-content">
                <p>
                  We use cookies improve your experience on our website. By
                  browsing this website, you agree to our use of cookies.
                </p>
              </div>
              <div className="cookie-notice-btn-wrapper">
                <Link className="btn-terms">Terms & Conditions </Link>
                <br />
                <Link
                  className="btn-decline text-danger"
                ...
                <br />
                <Link
                  className="btn-accept text-success"
