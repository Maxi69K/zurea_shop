...
const HomePageComponent = () => {
  ...
  return (
    <>
      ...
      <button onClick={() => dispatch(toggleModal(true))} className='btn btn-outline-primary d-block my-3 m-auto'>Modal</button>
      <h2 className='text-center m-3'>Top two products</h2>
      <TopTwoProductsComponent />
      <ModalComponents>
        <div className="text-center text-info">
          <h2>This is a modal</h2>
          <button onClick={()=>dispatch(toggleModal(false))} className='btn btn-sm btn-outline-light mt-3'>Accept</button>
        </div>
      </ModalComponents>
    </>
  );
